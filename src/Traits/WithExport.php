...
namespace Polirium\Datatable\Traits;
...
use Polirium\Datatable\Components\Exports\Export;
...
use Polirium\Datatable\Jobs\ExportJob;
...
trait WithExport
{
    ...
    {
        $defaultExportable = strval(config('polirium-datatable.exportable.default'));

        return strval(data_get(config('polirium-datatable.exportable'), $defaultExportable.'.'.$exportType));
    }
