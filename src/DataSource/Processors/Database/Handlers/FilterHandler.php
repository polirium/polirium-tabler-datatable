...
namespace Polirium\Datatable\DataSource\Processors\Database\Handlers;

use Illuminate\Database\Eloquent\Builder as EloquentBuilder;
use Illuminate\Database\Query\Builder as QueryBuilder;
use Illuminate\Support\Arr;
use Polirium\Datatable\DataSource\Builders\{Boolean, DatePicker, DateTimePicker, FilterBuilderEngine, InputText, MultiSelect, Number, Select};
use Polirium\Datatable\DataSource\Support\InputOperators;
                ...
                $query->where(function ($query) use ($filterType, $field, $value, $filterDefinitions) {
                    $filter = function ($query, $filterDefinitions, $filterType, $field, $value) {
                        ...
                        match ($filterType) {
                            ...
                            'builder' => (new FilterBuilderEngine($this->component, $filter))->builder($query, $field, $value),
                            default => null
                        };
                    };
