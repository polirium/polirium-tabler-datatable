...
namespace Polirium\Datatable\DataSource\Support;
...
class Sql
{
    ...
    public static function getSortFieldType(string $sortField): ?string
    {
        ...
        if (! Schema::hasColumn($data[0], $data[1])) {
            throw new Exception("There is no column with name '$column' on table '$tableName'. Please see: https://polirium-datatable.com/#/table/include-columns?id=fieldstring-field-string-datafield");
        }
