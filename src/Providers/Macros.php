...
use Polirium\Datatable\{Button, Column, PowerGridComponent};
use Polirium\Datatable\Components\Rules\RuleActions;
use Polirium\Datatable\DataSource\Support\Sql;
...
class Macros
{
    ...
    public static function actions(): void
    {
        ...
        Button::macro('confirm', function (?string $message = null) {
            $this->attributes([
                'wire:confirm' => $message ?? trans('polirium-datatable::datatable.buttons_macros.confirm.message'),
            ]);
        ...
        Button::macro('confirmPrompt', function (?string $message = null, string $confirmValue = 'Confirm') {
            $message = $message ?? trans('polirium-datatable::datatable.buttons_macros.confirm_prompt.message', ['confirm_value' => $confirmValue]);
