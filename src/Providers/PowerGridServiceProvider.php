...
namespace Polirium\Datatable\Providers;
...
use Polirium\Datatable\Commands\{CreateCommand, PublishCommand, UpdateCommand};
use Polirium\Datatable\Components\Filters\FilterManager;
use Polirium\Datatable\Components\Rules\RuleManager;
use Polirium\Datatable\{Livewire\Detail,
    Livewire\LazyChild,
    Livewire\PerformanceCard,
    PowerGridManager,
    Testing\TestActions};
use Polirium\Datatable\Support\PowerGridTableCache;

/** @codeCoverageIgnore */
class PowerGridServiceProvider extends ServiceProvider
{
    private string $packageName = 'polirium-datatable';
    ...
    public function register(): void
    {
        $this->mergeConfigFrom(
            __DIR__.'/../../resources/config/polirium-datatable.php',
            $this->packageName
        );
    ...
    {
        $this->publishes([
            __DIR__.'/../../resources/config/polirium-datatable.php' => config_path($this->packageName.'.php'),
        ], 'polirium-datatable-config');
