...
use Polirium\Datatable\DataSource\ProcessDataSource;
use Polirium\Datatable\Events\PowerGridPerformanceData;
use Polirium\Datatable\Exceptions\TableNameCannotCalledDefault;
...
class PowerGridComponent extends Component
{
    ...
    {
        $this->theme = app($this->customThemeClass() ?? strval(config('polirium-datatable.theme')))->apply();
    ...
    public function processNoDataLabel(): string
    {
        ...
        if ($noDataLabel instanceof View) {
            return $noDataLabel->with(
                [
                    'noDataLabel' => trans('polirium-datatable::datatable.labels.no_data'),
    ...
    {
        return view('polirium-datatable::components.table.no-data-label');
    }
