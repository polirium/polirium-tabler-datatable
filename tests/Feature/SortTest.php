...
use Polirium\Datatable\Tests\{Concerns\Components\DishesTable, Concerns\Components\DishesTableWithJoin};
...
dataset('sort join', [
    'tailwind -> id' => [DishesTable::class, (object) ['theme' => \Polirium\Datatable\Themes\Tailwind::class, 'field' => 'id']],
    'bootstrap -> id' => [DishesTable::class, (object) ['theme' => \Polirium\Datatable\Themes\Bootstrap5::class, 'field' => 'id']],
    'tailwind -> dishes.id' => [DishesTableWithJoin::class, (object) ['theme' => \Polirium\Datatable\Themes\Tailwind::class, 'field' => 'dishes.id']],
    'bootstrap -> dishes.id' => [DishesTableWithJoin::class, (object) ['theme' => \Polirium\Datatable\Themes\Bootstrap5::class, 'field' => 'dishes.id']],
    'daisyui -> id' => [DishesTable::class, (object) ['theme' => \Polirium\Datatable\Themes\DaisyUI::class, 'field' => 'id']],
    'daisyui -> dishes.id' => [DishesTableWithJoin::class, (object) ['theme' => \Polirium\Datatable\Themes\DaisyUI::class, 'field' => 'dishes.id']],
]);
