...
use Polirium\Datatable\Tests\Concerns\Components\OrderTable;
...
dataset('order table', [
    'tailwind' => [OrderTable::class, (object) ['theme' => \Polirium\Datatable\Themes\Tailwind::class]],
    'bootstrap' => [OrderTable::class, (object) ['theme' => \Polirium\Datatable\Themes\Bootstrap5::class]],
    'daisyui' => [OrderTable::class, (object) ['theme' => \Polirium\Datatable\Themes\DaisyUI::class]],
]);
