...
use Polirium\Datatable\Tests\Concerns\Components\DishesCalculationsCollectionTable;
...
dataset('calculations collection', [
    'tailwind' => [DishesCalculationsCollectionTable::class, (object) ['theme' => \Polirium\Datatable\Themes\Tailwind::class]],
    'bootstrap' => [DishesCalculationsCollectionTable::class, (object) ['theme' => \Polirium\Datatable\Themes\Bootstrap5::class]],
    'daisyui' => [DishesCalculationsCollectionTable::class, (object) ['theme' => \Polirium\Datatable\Themes\DaisyUI::class]],
]);
