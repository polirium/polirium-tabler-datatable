...
it('prepares action resources correctly', function () {
    ...
    config()->set('polirium-datatable.icon_resources.paths', $paths);
    config()->set('polirium-datatable.icon_resources.allowed', $allowed);
    config()->set('polirium-datatable.icon_resources.attributes', $iconAttributes);
