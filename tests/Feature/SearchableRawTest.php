...
use Polirium\Datatable\Tests\Concerns\Components\DishesSearchableRawTable;
...
dataset('searchable_raw_themes', [
    'tailwind' => [DishesSearchableRawTable::class, (object) ['theme' => \Polirium\Datatable\Themes\Tailwind::class]],
    'bootstrap' => [DishesSearchableRawTable::class, (object) ['theme' => \Polirium\Datatable\Themes\Bootstrap5::class]],
    'daisyui' => [DishesSearchableRawTable::class, (object) ['theme' => \Polirium\Datatable\Themes\DaisyUI::class]],
]);
