...
use Polirium\Datatable\Tests\Concerns\Components\DishesCalculationsTable;
...
dataset('calculations', [
    'tailwind' => [DishesCalculationsTable::class, (object) ['theme' => \Polirium\Datatable\Themes\Tailwind::class, 'join' => false]],
    'bootstrap' => [DishesCalculationsTable::class, (object) ['theme' => \Polirium\Datatable\Themes\Bootstrap5::class, 'join' => false]],
    'tailwind join' => [DishesCalculationsTable::class, (object) ['theme' => \Polirium\Datatable\Themes\Tailwind::class, 'join' => true]],
    'bootstrap join' => [DishesCalculationsTable::class, (object) ['theme' => \Polirium\Datatable\Themes\Bootstrap5::class, 'join' => true]],
    'daisyui' => [DishesCalculationsTable::class, (object) ['theme' => \Polirium\Datatable\Themes\DaisyUI::class, 'join' => false]],
    'daisyui join' => [DishesCalculationsTable::class, (object) ['theme' => \Polirium\Datatable\Themes\DaisyUI::class, 'join' => true]],
]);
