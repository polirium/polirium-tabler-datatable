...
>
    ...
    @else
        ...
        @if ($checkbox)
            @include('polirium-datatable::components.checkbox-all')
        @endif

        @foreach ($columns as $column)
            <x-polirium-datatable::cols
        ...
        @if (isset($actions) && count($actions))
            @php
                $responsiveActionsColumnName =
                    \Polirium\Datatable\Components\SetUp\Responsive::ACTIONS_COLUMN_NAME;
            ...
            >
                {{ trans('polirium-datatable::datatable.labels.action') }}
            </th>
        @endif
    @endif
</tr>
