...
@php
    ...
    $defaultAttributes = \Polirium\Datatable\Components\Filters\FilterSelect::getWireAttributes($field, $title);
        ...
        >
            ...
            >
                ...
                @if(!data_get($params, 'params.disableOptionAll', false))
                    <option value="">{{ trans('polirium-datatable::datatable.select.all') }}</option>
                @endif
